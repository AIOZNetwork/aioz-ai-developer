...
const response = await services.collections.postCollection({
    client: rawClient,
    body: {
...
const response = await services.collections.postCollectionList({
    client: rawClient,
    body: {
        filter: '...',  // string
        limit: '...',  // integer
...
const response = await services.collections.getCollectionById({
    client: rawClient,
    path: { id: '...' },
});
console.log(response.data);
...
const response = await services.collections.putCollectionById({
    client: rawClient,
    body: {
        description: '...',  // string
        name: '...',  // string
...
const response = await services.collections.postCollectionByIdItem({
    client: rawClient,
    body: {
        item_id: '...',  // string
...
const response = await services.collections.deleteCollectionByIdItem({
    client: rawClient,
    body: {
...
const response = await services.collections.putCollectionByIdVote({
    client: rawClient,
    path: { id: '...' },
});
console.log(response.data);
...
const response = await services.collections.postCollectionByUsernameList({
    client: rawClient,
    body: {
        limit: '...',  // integer
        offset: '...',  // integer
