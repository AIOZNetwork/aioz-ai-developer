...
const response = await services.users.getUserMe({ client: rawClient });
...
const response = await services.users.getUserOrgUsernames({ client: rawClient });
console.log(response.data);
```
...
const response = await services.users.patchUserProfile({
    client: rawClient,
    body: {
        avatar: '...',  // string
        bio: '...',  // string
...
const response = await services.users.postUserStatisticsEarnings({
    client: rawClient,
    body: {
        from: '...',  // string
        to: '...',  // string
...
const response = await services.users.postUserStatisticsSpendingCost({
    client: rawClient,
    body: {
        from: '...',  // string
        to: '...',  // string
...
const response = await services.users.getUserWalletDepositHistory({ client: rawClient });
console.log(response.data);
```
...
const response = await services.users.postUserWalletTransactionAnalytics({
    client: rawClient,
    body: {
        from: '...',  // string
        to: '...',  // string
...
const response = await services.users.getUserWalletTransactionHistory({ client: rawClient });
console.log(response.data);
```
...
const response = await services.users.postUserWalletTransactionRecent({
    client: rawClient,
    body: {
        from: '...',  // string
        limit: '...',  // integer
...
const response = await services.users.getUserWalletWithdrawHistory({ client: rawClient });
console.log(response.data);
```
...
const response = await services.users.getUserByUsername({
    client: rawClient,
    path: { username: '...' },
});
console.log(response.data);
