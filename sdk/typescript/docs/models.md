...
const response = await services.models.postModel({
    client: rawClient,
    body: {
        author_id: '...',  // string
...
const response = await services.models.postModelList({
    client: rawClient,
    body: {
        filter_by: '...',  // string
        language: '...',  // array[string]
...
const response = await services.models.postModelListByAuthorByUsername({
    client: rawClient,
    body: {
        language: '...',  // array[string]
        library: '...',  // array[string]
...
const response = await services.models.postModelMatchingTags({
    client: rawClient,
    body: {
        language: '...',  // array[string]
        library: '...',  // array[string]
...
const response = await services.models.getModelOrganizationByOrg({
    client: rawClient,
    path: { org: '...' },
});
console.log(response.data);
...
const response = await services.models.getModelById({
    client: rawClient,
    path: { id: '...' },
});
console.log(response.data);
...
const response = await services.models.putModelById({
    client: rawClient,
    body: {
        cover: '...',  // string
        dependency_id: '...',  // string
...
const response = await services.models.getModelByIdInfo({
    client: rawClient,
    path: { id: '...' },
});
console.log(response.data);
...
const response = await services.models.putModelByIdMetadata({
    client: rawClient,
    body: {
        language: '...',  // array[string]
        library: '...',  // array[string]
...
const response = await services.models.getModelByIdServing({
    client: rawClient,
    path: { id: '...' },
});
console.log(response.data);
...
const response = await services.models.postModelByIdStatistics({
    client: rawClient,
    body: {
        from: '...',  // string
        to: '...',  // string
...
const response = await services.models.getModelByIdTaskCost({
    client: rawClient,
    path: { id: '...' },
});
console.log(response.data);
...
const response = await services.models.getModelByIdVersioning({
    client: rawClient,
    path: { id: '...' },
});
console.log(response.data);
...
const response = await services.models.getModelByUsernameByName({
    client: rawClient,
    path: { username: '...', name: '...' },
});
console.log(response.data);
