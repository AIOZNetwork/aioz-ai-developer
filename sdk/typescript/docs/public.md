...
const response = await services.public.postPublicCostEstimating({
    client: rawClient,
    body: {
...
const response = await services.public.getPublicMetadata({ client: rawClient });
console.log(response.data);
```
...
const response = await services.public.getPublicTokenPrice({ client: rawClient });
console.log(response.data);
```
...
const response = await services.public.getPublicUserByUsernameMedals({
    client: rawClient,
    path: { username: '...' },
});
console.log(response.data);
...
const response = await services.public.getPublicUserByUsernameMedalsStatistics({
    client: rawClient,
    path: { username: '...' },
});
console.log(response.data);
