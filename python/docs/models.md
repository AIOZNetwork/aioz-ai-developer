...
```python
from aiozai_sdk.generated.models import CalculateCostToTrainingAiModelRequest

request = CalculateCostToTrainingAiModelRequest(
    dataset_id="...",  # string
...
```python
from aiozai_sdk.generated.models import GetListUserTrainingTaskRequest

request = GetListUserTrainingTaskRequest(
    limit="...",  # integer
    offset="...",  # integer
)
...
```python
from aiozai_sdk.generated.models import DeleteModelRequest
...
```python
from aiozai_sdk.generated.models import CheckValidToVerifyAiModelRequest
...
```python
from aiozai_sdk.generated.models import UpdateModelSettingRequest

request = UpdateModelSettingRequest(
    api_price="...",  # number
    sys_req_cpu_cores="...",  # integer
    sys_req_gpu_memory="...",  # integer
    sys_req_ram="...",  # integer
...
```python
from aiozai_sdk.generated.models import VerifyAiModelRequest
...
```python
from aiozai_sdk.generated.models import CalculateCostToVerifyAiModelRequest
...
```python
from aiozai_sdk.generated.models import CheckModelPendingStateRequest
...
```python
from aiozai_sdk.generated.models import GetApiPackageListRequest

request = GetApiPackageListRequest(
    limit="...",  # integer
    offset="...",  # integer
)
...
```python
from aiozai_sdk.generated.models import UpdateApiKeyRequest
...
```python
from aiozai_sdk.generated.models import GetApiKeyByIdRequest
