...
```python
from aiozai_sdk.generated.models import DownloadRepoZipRequest

request = DownloadRepoZipRequest(
    ref="...",  # string
    repoType="...",  # string
    zipType="...",  # string
)
...
```python
from aiozai_sdk.generated.models import CreateRepositoryContentRequest

request = CreateRepositoryContentRequest(
    branch_name="...",  # string
    email="...",  # string
...
```python
from aiozai_sdk.generated.models import DeleteRepositoryContentRequest

request = DeleteRepositoryContentRequest(
